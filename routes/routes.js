...
module.exports = function (app)
{
    ...
    app.get('/api/project/:project_id', projects.get);//!!!
    ...
    app.get('/api/project/:project_id/task/:task_id', tasks.get);//!!!
    ...
    app.get('/api/project/:project_id/task/:task_id/perform/:perform_id', performs.get);//!!!
